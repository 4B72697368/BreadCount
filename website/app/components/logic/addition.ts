...
const addition = (a1: fourBitHolder, a2: fourBitHolder, a3: fourBitHolder, a4: fourBitHolder, a5: fourBitHolder, a6: fourBitHolder, a7: fourBitHolder, a8: fourBitHolder, b1: fourBitHolder, b2: fourBitHolder, b3: fourBitHolder, b4: fourBitHolder, b5: fourBitHolder, b6: fourBitHolder, b7: fourBitHolder, b8: fourBitHolder) => {
    ...
    const b1D = BCDConversion(b1B.sum1, b1B.sum2, b1B.sum3, b1B.sum4, b1B.carry);
    ...
    const b2B = fourBitAdder(a2.LatchOne.value, a2.LatchTwo.value, a2.LatchThree.value, a2.LatchFour.value, b2.LatchOne.value, b2.LatchTwo.value, b2.LatchThree.value, b2.LatchFour.value, orGate(b1B.carry, b1D.carry));
    const b2D = BCDConversion(b2B.sum1, b2B.sum2, b2B.sum3, b2B.sum4, b2B.carry);
    ...
    const b3B = fourBitAdder(a3.LatchOne.value, a3.LatchTwo.value, a3.LatchThree.value, a3.LatchFour.value, b3.LatchOne.value, b3.LatchTwo.value, b3.LatchThree.value, b3.LatchFour.value, orGate(b2B.carry, b2D.carry));
    const b3D = BCDConversion(b3B.sum1, b3B.sum2, b3B.sum3, b3B.sum4, b3B.carry);
    ...
    const b4B = fourBitAdder(a4.LatchOne.value, a4.LatchTwo.value, a4.LatchThree.value, a4.LatchFour.value, b4.LatchOne.value, b4.LatchTwo.value, b4.LatchThree.value, b4.LatchFour.value, orGate(b3B.carry, b3D.carry));
    const b4D = BCDConversion(b4B.sum1, b4B.sum2, b4B.sum3, b4B.sum4, b4B.carry);
    ...
    const b5B = fourBitAdder(a5.LatchOne.value, a5.LatchTwo.value, a5.LatchThree.value, a5.LatchFour.value, b5.LatchOne.value, b5.LatchTwo.value, b5.LatchThree.value, b5.LatchFour.value, orGate(b4B.carry, b4D.carry));
    const b5D = BCDConversion(b5B.sum1, b5B.sum2, b5B.sum3, b5B.sum4, b5B.carry);
    ...
    const b6B = fourBitAdder(a6.LatchOne.value, a6.LatchTwo.value, a6.LatchThree.value, a6.LatchFour.value, b6.LatchOne.value, b6.LatchTwo.value, b6.LatchThree.value, b6.LatchFour.value, orGate(b5B.carry, b5D.carry));
    const b6D = BCDConversion(b6B.sum1, b6B.sum2, b6B.sum3, b6B.sum4, b6B.carry);
    ...
    const b7B = fourBitAdder(a7.LatchOne.value, a7.LatchTwo.value, a7.LatchThree.value, a7.LatchFour.value, b7.LatchOne.value, b7.LatchTwo.value, b7.LatchThree.value, b7.LatchFour.value, orGate(b6B.carry, b6D.carry));
    const b7D = BCDConversion(b7B.sum1, b7B.sum2, b7B.sum3, b7B.sum4, b7B.carry);
    ...
    const b8B = fourBitAdder(a8.LatchOne.value, a8.LatchTwo.value, a8.LatchThree.value, a8.LatchFour.value, b8.LatchOne.value, b8.LatchTwo.value, b8.LatchThree.value, b8.LatchFour.value, orGate(b7B.carry, b7D.carry));
    const b8D = BCDConversion(b8B.sum1, b8B.sum2, b8B.sum3, b8B.sum4, b8B.carry);
